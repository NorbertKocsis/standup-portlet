...
/**
 * Provides the local service interface for StandUpEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Daniel Javorszky
 * @see StandUpEntryLocalServiceUtil
...
public interface StandUpEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StandUpEntryLocalServiceUtil} to access the stand up entry local service. Add custom service methods to {@link com.liferay.support.standup.service.impl.StandUpEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
