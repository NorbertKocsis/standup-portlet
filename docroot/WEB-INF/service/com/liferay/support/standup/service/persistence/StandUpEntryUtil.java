...
public class StandUpEntryUtil {
	 ...
	 */
	public static StandUpEntry update(StandUpEntry standUpEntry)
		throws SystemException {
		return getPersistence().update(standUpEntry);
	}
	...
	public static StandUpEntry update(StandUpEntry standUpEntry,
		...
		return getPersistence().update(standUpEntry, serviceContext);
	}
	...
	*/
	...
	public static com.liferay.support.standup.model.StandUpEntry updateImpl(
		com.liferay.support.standup.model.StandUpEntry standUpEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(standUpEntry);
	}
