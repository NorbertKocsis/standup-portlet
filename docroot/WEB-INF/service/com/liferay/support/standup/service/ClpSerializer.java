...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"standup-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "standup-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(GlobalInformationClp.class.getName())) {
	...
	public static Object translateInputGlobalInformation(BaseModel<?> oldModel) {
	...
	public static Object translateOutputGlobalInformation(BaseModel<?> oldModel) {
		GlobalInformationClp newModel = new GlobalInformationClp();
